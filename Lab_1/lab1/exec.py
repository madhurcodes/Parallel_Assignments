...
workingDirectory = '/home/madhur/Doc/Parallel_Assignments/Lab_1/lab1'   #change this path
...
for folder in os.listdir(submissionDirectory):
	...
	if (contains == True):
		...
		if (res_compile == 0):
			...
			res_exec = os.system('timeout 100 ./out1 input0.txt 2 ' + studentDirectory + '/out2_0.txt  > ' + studentDirectory + '/res1')
			if (res_exec == 0):
			...
			for n in range(1,6):
				...
				res_exec = os.system('timeout 100 ./out1 ' + testid + ' 2 ' + studentDirectory + '/out2_' + str(n) + '.txt > ' + studentDirectory + '/res1')

				if (res_exec == 0):
					os.system('python3 l1p2.py out' + str(n) + '.txt ' + studentDirectory + '/out2_' + str(n) + '.txt > correct.txt')
			...
			for n in range(2, 6):
				testid = 'input' + str(n) + '.txt'
				res_exec = os.system('timeout 100 ./out1 ' + testid + ' 4 ' + studentDirectory + '/out4_' + str(n) + '.txt > ' + studentDirectory + '/res1')

				if (res_exec == 0):
					os.system('python3 l1p2.py out' + str(n) + '.txt ' + studentDirectory + '/out4_' + str(n) + '.txt > correct.txt')
			...
			for n in [2,4,5]:
				testid = 'input' + str(n) + '.txt'
				res_exec = os.system('timeout 100 ./out1 ' + testid + ' 8 ' + studentDirectory + '/out8_' + str(n) + '.txt > ' + studentDirectory + '/res1')

				if (res_exec == 0):
					os.system('python3 l1p2.py out' + str(n) + '.txt ' + studentDirectory + '/out8_' + str(n) + '.txt > correct.txt')
			...
			res_exec = os.system('timeout 100 ./out1 input2.txt 16 ' + studentDirectory + '/out16_2.txt > ' + studentDirectory + '/res1')
			if (res_exec == 0):
				os.system('python3 l1p2.py out2.txt ' + studentDirectory + '/out16_2.txt > correct.txt')
