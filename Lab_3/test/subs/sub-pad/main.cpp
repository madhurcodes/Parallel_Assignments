...
int main(int argc , char * argv[]){
    ...
    for(i=0;i<num_columns;i++){
        // char fname[80];
        // char num[10];
        fname = (char*) calloc(40, sizeof(char));
    ...
    int *csendcounts, *csdispls,  *crecvcounts,*crdispls; 
    ...
    csendcounts = (int*) calloc(psize, sizeof(int));
    csdispls = (int*) calloc(psize, sizeof(int));
    crecvcounts = (int*) calloc(psize, sizeof(int));
    crdispls = (int*) calloc(psize, sizeof(int));
